...
| `de.allow_skip_DE`                | `False`                        | Opt-in: smooth-interior cells (neighbour argmax agreement) skip the DE search — 1 DE generation then polish, instead of the full window (see below) |
