...
<p align="center">
  <img src="examples/example_plots/showcase/griewank_4d_1d.png" alt="Griewank 4D 1D profile for x0" width="280"/>
  <img src="examples/example_plots/showcase/griewank_4d_2d_a.png" alt="Griewank 4D 2D profile for (x0, x1)" width="280"/>
  <img src="examples/example_plots/showcase/griewank_4d_2d_b.png" alt="Griewank 4D 2D profile for (x1, x3)" width="280"/>
</p>

**Griewank 4D** (bounds [−20, 20]) — 947,119 target-function evaluations across all three projections. The ripple period differs per dimension (`cos(x_i / √(i+1))`), so the two 2D projections expose different structure.
