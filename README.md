...
**Himmelblau 4D** — 263,118 target-function evaluations across all three projections.
...
<p align="center">
  ...
  <img src="examples/example_plots/showcase/rosenbrock_4d_2d_b.png" alt="Rosenbrock 4D 2D profile for (x1, x2)" width="280"/>
</p>

**Rosenbrock 4D** — 49,947 target-function evaluations across all three projections.

<p align="center">
  <img src="examples/example_plots/showcase/ackley_4d_1d.png" alt="Ackley 4D 1D profile for x0" width="280"/>
  <img src="examples/example_plots/showcase/ackley_4d_2d_a.png" alt="Ackley 4D 2D profile for (x0, x1)" width="280"/>
  <img src="examples/example_plots/showcase/ackley_4d_2d_b.png" alt="Ackley 4D 2D profile for (x1, x2)" width="280"/>
</p>

**Ackley 4D** — 108,786 target-function evaluations across all three projections.
