...
The grid below shows 1D and 2D profile likelihood projections produced by ParaProf for three 4-dimensional analytic test functions (the two profiled dimensions are optimized out at each grid point). Total target-function evaluations across both projections per test function are listed alongside.
...
<table>
  <thead>
    <tr>
      ...
      <th align="center">1D profile of <i>x</i><sub>0</sub></th>
      <th align="center">2D profile of (<i>x</i><sub>0</sub>, <i>x</i><sub>1</sub>)</th>
      <th align="right">Target evaluations<br/>(both projections)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><b>Himmelblau 4D</b><br/><sub>16 equal-height peaks</sub></td>
      <td><img src="examples/example_plots/showcase/himmelblau_4d_1d.png" alt="Himmelblau 4D 1D profile" width="420"/></td>
      <td><img src="examples/example_plots/showcase/himmelblau_4d_2d.png" alt="Himmelblau 4D 2D profile" width="420"/></td>
      <td align="right">98,867</td>
    </tr>
    <tr>
      <td><b>Rosenbrock 4D</b><br/><sub>narrow curved valley</sub></td>
      <td><img src="examples/example_plots/showcase/rosenbrock_4d_1d.png" alt="Rosenbrock 4D 1D profile" width="420"/></td>
      <td><img src="examples/example_plots/showcase/rosenbrock_4d_2d.png" alt="Rosenbrock 4D 2D profile" width="420"/></td>
      <td align="right">33,362</td>
    </tr>
    <tr>
      <td><b>Ackley 4D</b><br/><sub>sharp central peak with ripples</sub></td>
      <td><img src="examples/example_plots/showcase/ackley_4d_1d.png" alt="Ackley 4D 1D profile" width="420"/></td>
      <td><img src="examples/example_plots/showcase/ackley_4d_2d.png" alt="Ackley 4D 2D profile" width="420"/></td>
      <td align="right">207,585</td>
    </tr>
  </tbody>
</table>

Contour lines correspond to the 68% and 95% Wilks confidence regions (Δχ² = 1, 3.84 in 1D and 2.30, 6.18 in 2D). The white star marks the best-fit grid point. Counts are the cumulative number of target-function evaluations across the 1D and 2D scans for each test function.
