"""SciPy differential-evolution per-cell adapter."""
...
class ScipyDE(BaseAdapter):
    ...
    def run(self, func, bounds, dims, grid_points, max_evals_per_cell, seed, comm=None):
            ...
            if n_profiled == 0:
                ...
                try:
                    differential_evolution(
                        ...
                        seed=seed + int(np.ravel_multi_index(cell_idx, shape)),
        ...
        return ProjectionResult(
            ...
            extra={"pop_size": self.pop_size, "max_iter": self.max_iter},
        )
